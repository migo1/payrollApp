{{--<div class="quickview-wrapper  open  builder hidden-sm hidden-xs" id="builder"> --}}
    <div class="quickview-wrapper builder hidden-sm hidden-xs" id="builder">
      <div class="p-l-30 p-r-30 ">
        <a class="builder-close quickview-toggle pg-icon" data-toggle="quickview" data-toggle-element="#builder" href="#">close</a>
        <a class="builder-toggle" data-toggle="quickview" data-toggle-element="#builder"><i class="pg-icon">paint_bucket</i></a>
        ...
        <div class="pull-bottom p-b-15 p-l-15 p-r-15 b-t b-grey p-t-15 m-l-15 m-r-15 bg-white builder-footer">
          <div class="pull-right">
            <form action="http://104.197.142.33/builder_process.php" method="POST" id="exportForm">
              ...
              <button aria-label="" id="btnExport" class="btn btn-cons btn-primary">Export</button>
            </form>
          </div>
        </div>
      </div>
