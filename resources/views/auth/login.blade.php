    ...
    <div class="login-wrapper ">
        ...
        <div class="login-container bg-white">
            <div class="p-l-50 p-r-50 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
                <img src="assets/img/pay_icon.png" alt="logo" data-src="assets/img/pay_icon.png"
                    data-src-retina="assets/img/pay_icon.png" width="48" height="48">
                <h2 class="p-t-25">Get Started <br /> with your Payroll</h2>
                <p class="mw-80 m-t-5">Sign in to your account</p>
                <!-- START Login Form -->
                <form method="POST" class="p-t-15" role="form" action="{{ route('login') }}">
                    @csrf
                    ...
                    <div class="form-group form-group-default">
                        ...
                        <div class="controls">
                            <input type="password" class="form-control @error('password') is-invalid @enderror"
                                name="password" placeholder="Credentials" required>
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
